 ...
 echo "<form class='padre2'>";
    ...
    // nombre de los panes
           ...
           echo "<div class='div2'>";
              ...
              echo "<circle cx='8' cy='8' r='8' fill='green'/>"; 
              echo "<path fill='white' d='M12.03 4.97a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z'/>";
              echo "</svg>";
              echo "</button>";
                  ...
                  echo "<circle cx='8' cy='8' r='8' fill='red'/>";
                  echo "<path fill='white' d='M5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293z'/>";
                  echo " </svg>";
                  echo "</button>";         
                  echo "</div>"; 
