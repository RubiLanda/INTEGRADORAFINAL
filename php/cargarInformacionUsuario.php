...
foreach($reg as $r){
   ...
   echo"
    <h3><b>Nombre:</b><input type='text' name='nombre' class='inputs' id='nombre' value='{$r->Nombre_A}'oninput=validarinputs(this) minlength='3' maxlength='50'></h3>
    <h3><b>Apellido Paterno:</b><input type='text' name='paterno' class='inputs' id='paterno' value='{$r->AP_A}' oninput=validarinputs(this) minlength='3' maxlength='50'></h3>
    <h3><b>Apellido Materno:</b><input type='text' name='materno' class='inputs' id='materno' value='{$r->AM_A}' oninput=validarinputs(this) minlength='3' maxlength='50'></h3>
